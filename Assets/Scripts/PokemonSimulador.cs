...
public class PokemonSimulador : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PokemonBag bagCharizard = new PokemonBag(pokemon006);
        PokemonBag bagFearow = new PokemonBag(pokemon022);

        PokemonBatalha batalha = new PokemonBatalha(bagCharizard, bagFearow);
