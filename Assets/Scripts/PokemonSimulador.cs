...
public class PokemonSimulador : MonoBehaviour
{
    void Start()
    {
        ...
        Pokemon pokemon011 = new Pokemon(11, "Metapode", 50, 20, 55);
        ...
        Pokemon pokemon020 = new Pokemon(20, "Rattata", 55, 81, 60);
        Pokemon pokemon021 = new Pokemon(21, "Spearow", 40, 60, 44);
        ...
        for (int i = 0; i < 4; i++)
        {
            batalha.Pokemon1Ataca(); // Charizard ATACA Fearow
            batalha.Pokemon2Ataca(); // Fearow ATACA Charizard
            batalha.Pokemon1Curar(porcaoSuper); // Charizard CURA com Porção super
            batalha.Pokemon2Ataca(); // Fearow ATACA Charizard
        }
