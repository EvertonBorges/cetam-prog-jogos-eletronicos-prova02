...
public class PokemonSimulador : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Pokemon pokemon003 = new Pokemon(3, "Venusaur", 80, 82, 83);
        ...
        Pokemon pokemon024 = new Pokemon(24, "Arbok", 60, 85, 69);
        ...
        PokemonBag pokemonBag006 = new PokemonBag(pokemon006);
        PokemonBag pokemonBag022 = new PokemonBag(pokemon022);
        ...
        PokemonBatalha batalha = new PokemonBatalha(pokemonBag006, pokemonBag022);
